...
export const ApartmentsContextProvider = ({ children }) => {
  ...
  useEffect(() => {
    fetch(
      `https://hotels4.p.rapidapi.com/properties/list?${new URLSearchParams({
      ...
      })}`,
      {
        ...
        headers: {
          'x-rapidapi-key':
            'c2390fc49fmsh53591c296aeb4d9p1f0e77jsn5c4547c05bb7',
  ...
  return (
    <ApartmentsContext.Provider
      value={{ apartments: apartments, setData: setApartmentsData }}
    >
      {children}
    </ApartmentsContext.Provider>
  );
